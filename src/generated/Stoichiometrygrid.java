...
@XmlType(name = "", propOrder = {
    "objecttagOrSgcomponent"
})
@XmlRootElement(name = "stoichiometrygrid")
public class Stoichiometrygrid {

    @XmlElements({
        @XmlElement(name = "objecttag", type = Objecttag.class),
        @XmlElement(name = "sgcomponent", type = Sgcomponent.class)
    })
    protected List<Object> objecttagOrSgcomponent;
    ...
    /**
     * Gets the value of the objecttagOrSgcomponent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the objecttagOrSgcomponent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObjecttagOrSgcomponent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getObjecttagOrSgcomponent() {
        if (objecttagOrSgcomponent == null) {
            objecttagOrSgcomponent = new ArrayList<Object>();
        }
        return this.objecttagOrSgcomponent;
    }
